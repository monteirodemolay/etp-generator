...
export const TIPOS_EVENTO = {
  ...
  OF_DISPUTA_ABERTA: "of.disputa_aberta",
  OF_DISPUTA_MENSAGEM: "of.disputa_mensagem",
  OF_DISPUTA_ENCERRADA: "of.disputa_encerrada",
  OF_ENTREGA_CONFIRMADA: "of.entrega_confirmada",
  OF_ENTREGA_DESFEITA: "of.entrega_desfeita",
  OF_NOTA_FISCAL_ANEXADA: "of.nota_fiscal_anexada",
  OF_NOTA_FISCAL_ATESTADA: "of.nota_fiscal_atestada",
  OF_NOTA_FISCAL_ATESTO_DESFEITO: "of.nota_fiscal_atesto_desfeito",
...
export const ROTULOS_EVENTO = {
  ...
  [TIPOS_EVENTO.OF_DISPUTA_ABERTA]: "Abriu uma disputa com o fornecedor",
  [TIPOS_EVENTO.OF_DISPUTA_MENSAGEM]: "Respondeu numa disputa em andamento",
  [TIPOS_EVENTO.OF_DISPUTA_ENCERRADA]: "Encerrou a disputa com a solução final",
  ...
  [TIPOS_EVENTO.OF_NOTA_FISCAL_ANEXADA]: "Anexou uma Nota Fiscal",
  [TIPOS_EVENTO.OF_NOTA_FISCAL_ATESTADA]: "Atestou uma Nota Fiscal",
  [TIPOS_EVENTO.OF_NOTA_FISCAL_ATESTO_DESFEITO]: "Desfez o ateste de uma Nota Fiscal",
